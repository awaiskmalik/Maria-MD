...
await Maria.sendMessage(from, {text: Ayushlod[i], edit: key });
        ...
        if (autobio) {
            Maria.updateProfileStatus(`Hey, future leaders! 🌟 Nibras-Md is here to inspire and lead, thanks to Malik Bots, Inc. 🚀 ${runtime(process.uptime())} `).catch(_ => _)
        }
 ...
 *Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
  ...
  *🌟 Repo:* https://github.com/awaiskmalik/Nibras-MD \n
  *🌟 Pair:*https://replit.com/@awaiskmalik/NIBRAS-PAIRING
...
case 'chatgpt': case 'gpt':{
        ...
        const helptxt = `_*📍[Rules for Nibras-MD usage]📍*_\n\n\n*>>>* use -support to get the Official group link in your dm.\n\n*--->* If you want to add Nibras-MD in your group the contact the owner by *-owner/-mods* \n\n*--->* Dont use wrong command, use the command given in the *-help* list \n\n* Dont spam the bot with commands if Nibras-MD is not responding, its means the maybe owner is offline or facing internet issue. \n\n*IF YOU DONT FOLLOW THE RULES THEN YOU WILL BE BANNED* 🚫 \n\n\n*©️ Malik Bots inc* `
      ...
      case "info":
        ...
        let ifx = `🌟『ɴɪʙʀᴀs-ᴍᴅ』🌟
*🌟Description:* A WhatsApp Bot With Rich  features based on Nibras
        ...
        for (let i = 0; i < randomxx; i++) {
            ...
            try {
                ...
                if (anu1 == '401' || anu1.status.length == 0) {
                    ...
                    text66 += `📞 *Number:* wa.me/${anu[0].jid.split("@")[0]}\n 🌐 ️*Bio :* ${anu1.status}\n⏳️*Last update :* ${moment(anu1.setAt).tz('Asia/Islamabad').format('HH:mm:ss DD/MM/YYYY')}\n\n`
                }
            } catch {
...
"eat 2 tablespoons of rice without any side dishes, if it's dragging you can drink",
         ...
         "say i love the bot owner Awais through voice note",
...
case 'truth':
                 ...
                 "do you love the bot creator Awais?",
...
const txt = `Welcome *${pushname}*   ${Ayushytimewisher},

I am *Nibras-MD*, a bot developed by *ᴀᴡᴀɪs ᴍᴀʟɪᴋ*.
